    ...
    <div>
      <div className="bg-[#111] min-h-screen text-white flex flex-col items-center">
        ...
        <div className="flex justify-center mt-6 w-full px-4">
          ...
          <div className="w-full max-w-3xl bg-[rgba(255,255,255,0.03)] rounded-lg p-6">
            <article className="text-lg md:text-xl leading-8 md:leading-9 text-justify text-gray-100">
              {/* Nếu backend trả HTML, render bằng dangerouslySetInnerHTML.
                  Nếu là plain text, lớp whitespace-pre-line sẽ giữ xuống dòng. */}
              <div
